...
**Не нажимайте RESET BATCH между районами.** Организации из соседних районов,
попавшие в выдачу, останутся в хранилище и пригодятся, когда дойдёт очередь до
их района — дедуп по `place_id` не даст собрать их дважды.
